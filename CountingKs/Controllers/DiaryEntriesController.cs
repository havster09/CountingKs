    ...
    public class DiaryEntriesController : BaseApiController
    {
        ...
        public HttpResponseMessage Post(DateTime diaryId, [FromBody]DiaryEntryModel model)
        {
            try
            {
                ...
                {
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "Duplicate not allowed");
                }
        ...
        [HttpPut]
        [HttpPatch]
        public HttpResponseMessage Put(DateTime diaryId, int id, [FromBody] DiaryEntryModel model)
        {
            try
            {
